...
# 矩形戦略はpixivの戦略と一緒
        ...
        cv2.putText(orig_img, text, (left, top-6), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 0), 2)
        print(text)

    print("save results to " + image_file + "_predicted_by_yolov2.jpg")
    cv2.imwrite(image_file + "_predicted_by_yolov2.jpg", orig_img)
